...
public class KernelMessageConstant {
    ...
    public void setNotFound(String notFound) {
        KernelMessageConstant.NOT_FOUND = notFound;
    }

    @Value("${column.notempty}")
    public void setColumnNotEmpty(String columnNotEmpty) {
        KernelMessageConstant.COLUMN_NOT_EMPTY = columnNotEmpty;
    }
    ...
    public void setNotSupported(String notSupported) {
        KernelMessageConstant.NOT_SUPPORTED = notSupported;
    }
    ...
    public void setIoWriteError(String ioWriteError) {
        KernelMessageConstant.IO_WRITE_ERROR = ioWriteError;
    }
    ...
    public void setKeySpecificationsInvalid(String keySpecificationsInvalid) {
        KernelMessageConstant.KEY_SPECIFICATIONS_INVALID = keySpecificationsInvalid;
    }
    ...
    public void setMessageExtensionMoreThan10Extensions(
            String messageExtensionMoreThan10Extensions) {
