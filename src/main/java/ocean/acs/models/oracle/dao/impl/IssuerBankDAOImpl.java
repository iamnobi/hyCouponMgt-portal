...
public class IssuerBankDAOImpl implements IssuerBankDAO {
    ...
    private final ocean.acs.models.oracle.repository.IssuerBankRepository repo;
    ...
    public Optional<IssuerBankDO> update(PortalIssuerBankDO issuerBankDO) {
        ...
        IssuerBank issuerBank = repo.findById(issuerBankDO.getId()).map(e -> {
            ...
            e.setCode(issuerBankDO.getCode());
            e.setThreeDSMethodUrl(issuerBankDO.getThreeDSMethodUrl());
            e.setAcsUrl(issuerBankDO.getAcsUrl());
            e.setAcsRefNumber(issuerBankDO.getAcsRefNumber());
            //e.setAcsOperatorId(issuerBankDO.getAcsOperatorId());//00003 allow control asc/3ds oper id by user
    ...
    public Long getAcsOperatorIdNextVal() {
        return repo.getAcsOperatorIdNextVal();
    }
