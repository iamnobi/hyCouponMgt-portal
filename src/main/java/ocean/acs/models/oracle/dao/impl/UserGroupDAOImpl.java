...
public class UserGroupDAOImpl implements UserGroupDAO {
    ...
    private final ocean.acs.models.oracle.repository.UserGroupRepository repo;
    ...
    public int deleteByIssuerBankId(long issuerBankId, String deleter, long deleteMillis) {
        return deleteIssuerBankRelativeDataHelper.deleteByIssuerBankId(UserGroup.class, issuerBankId, deleter, deleteMillis);
    }
