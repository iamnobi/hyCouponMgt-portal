...
public class OtpSendingSettingDAOImpl implements OtpSendingSettingDAO {
    ...
    private final ocean.acs.models.oracle.repository.OtpSendingSettingRepository repo;
    ...
    public int deleteByIssuerBankId(long issuerBankId, String deleter, long deleteMillis) {
        return deleteIssuerBankRelativeDataHelper.deleteByIssuerBankId(OtpSendingSetting.class, issuerBankId, deleter, deleteMillis);
    }
