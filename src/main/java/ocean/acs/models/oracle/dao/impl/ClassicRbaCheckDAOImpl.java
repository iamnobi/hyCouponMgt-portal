...
public class ClassicRbaCheckDAOImpl implements ClassicRbaCheckDAO {
    ...
    private final ocean.acs.models.oracle.repository.ClassicRbaCheckRepository repo;
    ...
    public int deleteByIssuerBankId(long issuerBankId, String deleter, long deleteMillis) {
        return deleteIssuerBankRelativeDataHelper.deleteByIssuerBankId(ClassicRbaCheck.class, issuerBankId, deleter, deleteMillis);
    }
