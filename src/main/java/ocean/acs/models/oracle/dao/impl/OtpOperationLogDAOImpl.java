...
public class OtpOperationLogDAOImpl implements OtpOperationLogDAO {
    ...
    private final ocean.acs.models.oracle.repository.OtpOperationLogRepository repo;
    ...
    public int deleteByIssuerBankId(long issuerBankId, String deleter, long deleteMillis) {
        return deleteIssuerBankRelativeDataHelper.deleteByIssuerBankId(OtpOperationLog.class, issuerBankId, deleter, deleteMillis);
    }
