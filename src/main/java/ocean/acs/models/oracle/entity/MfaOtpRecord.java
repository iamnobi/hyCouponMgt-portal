...
public class MfaOtpRecord {
     ...
     */
    @Id
    @SequenceGenerator(name = "SQ_MFA_OTP_RECORD", sequenceName = "MFA_OTP_RECORD_SEQ", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SQ_MFA_OTP_RECORD")
