...
public class TransactionLog implements Serializable {
    ...
    @Id
    @GenericGenerator(name = "kernel_transaction_log_seq_generator",
            strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
            parameters = {
                    @org.hibernate.annotations.Parameter(name = "sequence_name",
                            value = "KERNEL_TRANSACTION_LOG_ID_SEQ"),
                    @org.hibernate.annotations.Parameter(name = "increment_size", value = "1")})
    @GeneratedValue(strategy = GenerationType.SEQUENCE,
            generator = "kernel_transaction_log_seq_generator")
    ...
    public static TransactionLog valueOf(TransactionLogDO d) {
        ...
        a.setChallengeOtpChannel(d.getChallengeOtpChannel());
