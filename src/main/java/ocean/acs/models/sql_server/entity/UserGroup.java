 ...
 * 4. {@link UserGroup} Field
 * 5. {@link UserGroup} All args constructor
 * 6. {@link UserGroup#valueOf(UserGroupDO)
 * 7. {@link DBKey}}
 * 8. {@link UserGroupDO}
 * 9. {@link UserGroupDO#valueOf(ocean.acs.models.oracle.entity.UserGroup)}
 * 10. {@link UserGroupDO#valueOf(UserGroup)}
...
public class UserGroup extends OperatorInfo {
    ...
    /** 檢視明碼卡號 */
    @NonNull
    @Column(name = DBKey.COL_USER_GROUP_MODULE_CAN_SEE_PAN)
    @Enumerated(EnumType.STRING)
    private Boolean moduleCanSeePan;

    /** 檢視明碼卡號 */
    @NonNull
    @Column(name = DBKey.COL_USER_GROUP_CAN_SEE_PAN_QUERY)
    @Enumerated(EnumType.STRING)
    ...
    public UserGroup(Long id, Long issuerBankId, String name, UserGroupType type,
      UserGroupScope scope, Boolean moduleCanSeePan, Boolean canSeePanQuery,
      Boolean moduleReport, Boolean reportQuery,
      ...
      Boolean mimaPolicyModify, Boolean moduleBankDataKey, Boolean bankDataKeyQuery,
