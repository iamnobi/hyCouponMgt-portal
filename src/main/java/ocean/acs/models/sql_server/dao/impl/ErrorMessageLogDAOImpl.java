...
public class ErrorMessageLogDAOImpl implements ErrorMessageLogDAO {
    ...
    private final ocean.acs.models.sql_server.repository.ErrorMessageLogRepository repo;
    private final ocean.acs.models.sql_server.repository.TransactionLogRepository transactionLogRepository;
    ...
    public ErrorMessageLogDO saveError(TransactionLogDO transactionLogDO, ErrorDO errorDO)
        ...
        try {
            ...
            transactionLog.setErrorMessageLogID(errorMessageLog.getId());
