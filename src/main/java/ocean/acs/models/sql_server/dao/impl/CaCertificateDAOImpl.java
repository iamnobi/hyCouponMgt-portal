...
public class CaCertificateDAOImpl implements CaCertificateDAO {
    ...
    private final ocean.acs.models.sql_server.repository.CaCertificateRepository repo;
    ...
    public List<CaCertificateDO> findByCardBrand(String cardBrand) {
        List<CaCertificate> caCertificateOpt =
                repo.findByCardBrandAndDeleteFlagFalseOrderByExpireMillisDesc(cardBrand);
        return caCertificateOpt.stream().map(CaCertificateDO::valueOf).collect(Collectors.toList());
    }
