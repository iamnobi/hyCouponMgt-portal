...
import ocean.acs.models.sql_server.entity.Auditing;
...
public class AuditingDAOImpl implements AuditingDAO {
    ...
    private final ocean.acs.models.sql_server.repository.AuditingRepository repo;
    ...
    public Optional<Page<AuditingDO>> findByFunctionTypeAndAuditStatusExcludeSelf(Long issuerBankId,
        ...
        Page<AuditingDO> doPage = new PageImpl<>(
                resultPage.stream().map(AuditingDO::valueOf).collect(Collectors.toList()), paging,
    ...
    public Optional<Page<AuditingDO>> findAllAuditStatusExcludeSelf(Long issuerBankId,
        ...
        List<AuditingDO> doList =
                resultPage.stream().map(AuditingDO::valueOf).collect(Collectors.toList());
    ...
    public List<AuditingDO> findDraftForNewWhitelistSetting(Long issuerBankId, Long panId) {
        ...
        return repo.findNewWhitelistSettingByDraftDataLike(queryByDraftData).stream()
                .map(AuditingDO::valueOf).collect(Collectors.toList());
    }
