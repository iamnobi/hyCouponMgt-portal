...
import ocean.acs.models.sql_server.entity.ChallengeViewMessage;
...
public class ChallengeViewMessageDAOImpl implements ChallengeViewMessageDAO {
    ...
    private final ocean.acs.models.sql_server.repository.ChallengeViewMessageRepository repo;
    ...
    public List<ChallengeViewMessageDO> findByIssuerBankIdAndLanguageCode(
        ...
        try {
            ...
            log.error("[findByIssuerBankIdAndLanguageCode] unknown exception", e);
