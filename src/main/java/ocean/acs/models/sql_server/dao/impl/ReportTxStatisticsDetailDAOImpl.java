...
public class ReportTxStatisticsDetailDAOImpl implements ReportTxStatisticsDetailDAO {
    ...
    private final ocean.acs.models.sql_server.repository.ReportTxStatisticsDetailRepository repo;
    ...
    public Optional<ReportTxStatisticsDetailDO> findByCardBrandAndYearAndMonthAndDay(
        ...
        try {
            return repo.findByIssuerBankIdAndCardBrandAndYearAndMonthAndDayOfMonth(issuerBankId,
    ...
    public List<ReportTxStatisticsDetailDO> statisticByIssuerBankIdAndYearAndMonthAndDay(
        ...
        try {
            List<ReportTxStatisticsDetailDO> resultList = repo
                    .statisticByIssuerBankIdAndYearAndMonthAndDay(issuerBankId, year, month, day);
            if (resultList == null || resultList.isEmpty()) {
                return Collections.emptyList();
            }
