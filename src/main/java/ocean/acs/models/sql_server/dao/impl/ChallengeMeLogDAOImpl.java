...
public class ChallengeMeLogDAOImpl implements ChallengeMeLogDAO {
    ...
    private final ocean.acs.models.sql_server.repository.ChallengeMeLogRepository repo;
...
//    }
    ...
    private ChallengeMeLog createChallengeMeLog(ChallengeMeLogDO challengeMeLogDO) throws DatabaseException {
        ChallengeMeLog challengeMeLog = new ChallengeMeLog();
        challengeMeLog.setChallengeLogId(challengeMeLogDO.getChallengeLogId());
        challengeMeLog.setMessageType(challengeMeLogDO.getMessageType());
        challengeMeLog.setData(challengeMeLogDO.getData());
        challengeMeLog.setMeID(challengeMeLogDO.getMeID());
        challengeMeLog.setCriticalityIndicator(challengeMeLogDO.getCriticalityIndicator());
        challengeMeLog.setName(challengeMeLogDO.getName());
        challengeMeLog.setSysCreator(challengeMeLogDO.getSysCreator());
        challengeMeLog.setCreateMillis(challengeMeLogDO.getCreateMillis());
        return challengeMeLog;
    }
