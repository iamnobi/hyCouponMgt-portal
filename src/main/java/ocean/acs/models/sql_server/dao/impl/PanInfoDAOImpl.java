...
public class PanInfoDAOImpl implements PanInfoDAO {
    ...
    private final ocean.acs.models.sql_server.repository.PanInfoRepository repo;
    private final ocean.acs.models.sql_server.repository.PanOtpStatisticsRepository panOtpStatisticsRepo;
