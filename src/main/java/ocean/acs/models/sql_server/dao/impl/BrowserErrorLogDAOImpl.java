...
public class BrowserErrorLogDAOImpl implements BrowserErrorLogDAO {
    ...
    private final ocean.acs.models.sql_server.repository.BrowserErrorLogRepository repo;
    ...
    public List<BrowserErrorLogResultDO> findByIssuerBankIdAndYearAndMonth(long issuerBankId,
        ...
        return npJdbcTemplate.query(BROWSER_ERROR_LOG_QUERY_MONTH, params, new BrowserErrorLogResultDORowMapper());
    }
    ...
    public List<BrowserErrorLogResultDO> findByIssuerBankIdAndYearAndMonthAndDay(long issuerBankId,
        ...
        return npJdbcTemplate.query(BROWSER_ERROR_LOG_QUERY_DAY, params, new BrowserErrorLogResultDORowMapper());
    }
}
