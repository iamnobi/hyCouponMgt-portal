...
public class ErrorCodeDAOImpl implements ErrorCodeDAO {
    ...
    private final ocean.acs.models.sql_server.repository.ErrorCodeMappingRepository repo;
    private final ocean.acs.models.sql_server.repository.ErrorIssueGroupRepository errorIssueGroupRepo;
