...
import com.cherri.acs_portal.filter.DecryptionInterceptor;
import com.cherri.acs_portal.filter.EncryptionInterceptor;
...
public class OkHttpConnector {
    ...
    private static final okhttp3.MediaType APPLICATION_JSON =
    ...
    @Autowired
    public OkHttpConnector(Environment environment, ObjectMapper objectMapper) {
        ...
        OkHttpClient.Builder clientBuilder =
          new OkHttpClient.Builder()
            ...
            .hostnameVerifier(OkHttpConnector::verify)
